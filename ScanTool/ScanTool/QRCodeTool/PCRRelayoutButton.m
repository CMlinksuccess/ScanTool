...
@implementation PCRRelayoutButton
- (void)setLzType:(PCRRelayoutButtonType)lzType {
    _lzType = lzType;
    
    if (lzType != PCRRelayoutButtonTypeNomal) {
